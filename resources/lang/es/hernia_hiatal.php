<?php
	return [
		...
		'sintomas_paragraph' => '<p>Rara vez se presentan <b>síntomas de hernia hiatal</b>. La principal molestia que se puede percibir es dolor ocasionado por el reflujo del ácido gástrico, el aire o la bilis.</p><p>Otros <b>síntomas de hernia hiatal</b> pueden ser:</p><ul class="lista"><li>Dolor torácico</li><li>Acidez gástrica que empeora al agacharse o acostarse.</li><li>Dificultad para deglutir.</li></ul>',
 	];
?>