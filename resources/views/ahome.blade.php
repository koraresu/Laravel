...
<head>
<meta charset="utf-8">
<title>MediPro - Health & Medical Responsive Template</title>
<!-- Stylesheets -->
...
<div class="page-wrapper"> 
      ...
      <div class="container clearfix ptn pbn"> 
        ...
        <div class="top-left pull-left">
          <ul class="info-nav clearfix">
            <li> 
              <!--Social Links-->
              <div class="social-links pull-left"><a href="#"><span class="fa fa-facebook-f"></span></a> <a href="#"><span class="fa fa-twitter"></span></a> <a href="#"><span class="fa fa-google-plus"></span></a> <a href="#"><span class="fa fa-linkedin"></span></a> </div>
            </li>
  ...
  <section class="hero hero-slider-wrapper">
    <div class="hero-slider">
      <div class="slide"> <img src="images/slider/1.jpg" alt>
        <div class="title"> <span>Welcome to Medipro Template for</span>
          <h1>Foundation</h1>
          <a href="#" class="btn theme-btn">Buy Now</a> </div>
      </div>
      <div class="slide"> <img src="images/slider/2.jpg" alt>
        <div class="title"> <span>Welcome to Medipro Template for</span>
          <h1>Hospital</h1>
          <a href="#" class="btn theme-btn">Buy Now</a> </div>
      </div>
      <div class="slide"> <img src="images/slider/3.jpg" alt>
        <div class="title"> <span>Welcome to Medipro Template for</span>
          <h1>business</h1>
          <a href="#" class="btn theme-btn">Buy Now</a> </div>
      </div>
